    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-[3fr_2fr] lg:gap-16">
          ...
          >
            {/* Bio paragraphs */}
            <div className="flex flex-col gap-5 text-base leading-relaxed text-(--color-text-muted)">
            ...
            {/* Personal quote */}
            <blockquote
              className="relative pl-5 italic text-(--color-text-muted) text-[15px] leading-relaxed
              ...
              {HIGHLIGHT_TAGS.map((tag) => (
                <span
                  ...
                  className="inline-flex items-center rounded-full border border-(--glass-border)
                             bg-(--color-glass) px-4 py-1.5 text-xs font-medium
                             tracking-wide text-(--color-text-muted) backdrop-blur-sm
                             transition-colors duration-200 hover:border-(--glass-border)
              ...
              <GlassCard className="flex flex-col gap-3">
                ...
                <ul className="flex flex-col gap-2.5 mt-2">
                  {FUN_ITEMS.map((item) => (
                    <li
                      key={item}
                      className="text-sm font-medium text-(--color-text-muted) transition-colors
                                 duration-200 hover:text-(--color-text)"
                    >
                      {item}
                    </li>
                  ))}
